...
class KMeansClustering:
    ...
    def elbow_plot(self,data):
        ...
        try:
            ...
            plt.ylabel('WCSS')
            #plt.show()
            #my_file = self.rootProjPath+'\\preprocessing_data\\K-Means_Elbow.PNG'
            #plt.savefig(my_file)
    ...
    def create_clusters(self,data,number_of_clusters):
        ...
        try:
            ...
            self.file_op = file_methods.File_Operation(self.file_object,self.logger_object,self.rootProjPath)
