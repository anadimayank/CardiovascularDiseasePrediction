...
class dBOperation:
    ...
    def __init__(self):
        #my_file = rootProjPath+'\\Prediction_Database\\'
        #self.path = my_file
        #my_file = rootProjPath+'\\Prediction_Raw_Files_Validated\\Bad_Raw'
    ...
    def dataBaseConnection(self,DatabaseName):
        ...
        try:
            ...
            #my_file = self.rootProjPath+'\\Prediction_Logs\\DataBaseConnectionLog.txt'
            #file = open(my_file, 'a+')
    ...
    def createTableDb(self,DatabaseName,column_names):
        ...
        try:
            ...
            conn.close()
            #my_file = self.rootProjPath+'\\Prediction_Logs\\DbTableCreateLog.txt'
            #file = open(my_file, 'a+')
    ...
    def insertIntoTableGoodData(self,Database):
        ...
        #my_file = self.rootProjPath+'\\Prediction_Logs\\DbInsertLog.txt'
    ...
    def selectingDatafromtableintocsv(self,Database):
        ...
        """
                ...
                """
        #my_file =self.rootProjPath+'\\Prediction_FileFromDB\\'
        #self.fileFromDb = my_file
        #my_file = my_file+'InputFile.csv'
        #self.fileName = 'InputFile.csv' #my_file
        #my_file = self.rootProjPath+'\\Prediction_Logs\\ExportToCsv.txt'
        #log_file = open(my_file, 'a+')
